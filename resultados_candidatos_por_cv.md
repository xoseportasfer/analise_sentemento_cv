...
--- Iniciando Triaje Automático de 10 Candidatos ---
...
👤 CANDIDATO #1
   ...
   - Salario: 65k anuales
   - Perfil: 8 años de trayectoria, líder en entornos distribuidos
--------------------------------------------------
👤 CANDIDATO #2
   - Nivel: Junior
   - Tech:  Java
   ...
   - Perfil: Reciente graduado en Ingeniería Informática
--------------------------------------------------
👤 CANDIDATO #3
   - Nivel: Middle
   - Tech:  .NET
   - Disponibilidad: 1 mes
   - Salario: 45.000 euros
   - Perfil: Backend developer with .NET Core and C#, experienced in banking sector.
--------------------------------------------------
👤 CANDIDATO #4
   - Nivel: Senior
   - Tech:  JavaScript
   ...
   - Salario: No especificado
   - Perfil: Fullstack senior especializado en ecosistema JavaScript
--------------------------------------------------
👤 CANDIDATO #5
   - Nivel: Middle
   - Tech:  Python
   - Disponibilidad: Inmediata
   - Salario: 30k
   - Perfil: Software Engineer with 2 years of experience in data analysis and backend.
--------------------------------------------------
👤 CANDIDATO #6
   - Nivel: Senior
   - Tech:  Java
   - Disponibilidad: 1 mes
   - Salario: 75k
   - Perfil: Arquitecto Java con más de 12 años de experiencia
--------------------------------------------------
👤 CANDIDATO #7
   - Nivel: Junior
   - Tech:  .NET
...
👤 CANDIDATO #8
   ...
   - Disponibilidad: Inmediata
   - Salario: No especificado
   - Perfil: Lead Engineer en Go y C++. Experto en sistemas de baja latencia.
--------------------------------------------------
👤 CANDIDATO #9
   - Nivel: Middle
   - Tech:  Java
...
👤 CANDIDATO #10
   ...
   - Disponibilidad: Inmediata
   - Salario: No especificado
   - Perfil: Último año estudiante con conocimientos básicos de Python y algoritmos
--------------------------------------------------

Triaje completado. Base de datos actualizada con 10 perfiles.
